...
See coordination/templates/dashboard_schema.md for available fields.
```
...
**Solution:** Move template to coordination/templates/completion_report.md, reference it
...
4. **Extract Report Templates** (~100 lines saved)
   - Move completion report template to coordination/templates/
...
1. Create `coordination/templates/` directory
2. Extract templates:
