...
**Extraction Strategy:**
```
Create: coordination/templates/developer_prompt_template.md
...
"Build developer prompt following coordination/templates/developer_prompt_template.md"
```
...
**Extraction Strategy:**
```
Create: coordination/templates/agent_response_parsing.md
...
Orchestrator Reference:
"Parse agent responses using coordination/templates/agent_response_parsing.md strategies"
```
...
**Extraction Strategy:**
```
Create: coordination/templates/techlead_prompt_template.md
...
Orchestrator Reference:
"Build Tech Lead prompt following coordination/templates/techlead_prompt_template.md"
```
...
**Extraction Strategy:**
```
Create: coordination/templates/qa_prompt_template.md
...
Orchestrator Reference:
"Build QA prompt following coordination/templates/qa_prompt_template.md"
```
...
1. **Output capsule:** Use template from coordination/templates/message_templates.md
2. **Build prompt:** Use coordination/templates/{agent}_prompt_template.md
3. **Spawn agent:** Task(subagent_type: "{agent}", prompt: "{built_prompt}")
4. **Parse response:** Use coordination/templates/agent_response_parsing.md
...
Use:
🔴 MANDATORY: Follow coordination/templates/developer_prompt_template.md (no shortcuts)
```
...
**Files to Create:**
1. `coordination/templates/developer_prompt_template.md` (1,100 lines)
2. `coordination/templates/qa_prompt_template.md` (150 lines)
3. `coordination/templates/techlead_prompt_template.md` (170 lines)
4. `coordination/templates/agent_response_parsing.md` (400 lines)
5. `coordination/templates/workflow_patterns.md` (200 lines - generic spawn pattern)
...
1. Create `coordination/templates/developer_prompt_template.md`
...
1. Create `coordination/templates/agent_response_parsing.md`
...
4. **Template location?** `coordination/templates/` or different folder?
