...
**For detailed specialization mapping logic, read:** `bazinga/templates/pm_specializations.md`

**Quick reference:**
1. Read `bazinga/project_context.json` for component info
2. Match task group file paths to components
3. Use component's `suggested_specializations` if available
4. Fallback: map technology names to template paths
5. Include specializations in task group definition and bazinga-db call
