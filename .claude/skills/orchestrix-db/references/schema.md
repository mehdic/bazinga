# Orchestrix Database Schema Reference

This document provides complete reference documentation for the Orchestrix database schema.
...
- **Location**: `/home/user/orchestrix/orchestrix/orchestrix.db`
...
CREATE TABLE task_groups (
    ...
    specializations TEXT,  -- JSON array of specialization file paths (e.g., ["orchestrix/templates/specializations/01-languages/typescript.md"])
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
- `specializations`: JSON array of specialization file paths assigned by PM (e.g., `["orchestrix/templates/specializations/01-languages/typescript.md", "orchestrix/templates/specializations/02-frameworks-frontend/nextjs.md"]`)
...
INSERT INTO model_config (agent_role, model, rationale) VALUES
    ...
    ('validator', 'sonnet', 'Orchestrix verification');
```
...
```bash
sqlite3 orchestrix.db "VACUUM"
```

### Check Integrity
```bash
sqlite3 orchestrix.db "PRAGMA integrity_check"
```
