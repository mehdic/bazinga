# Orchestrix-DB Command Examples

This document provides practical examples of using the orchestrix-db skill commands.

## Command Format

All commands follow this pattern:
```bash
python3 /path/to/orchestrix_db.py --db /path/to/orchestrix.db <command> [arguments...]
```
...
- Skills config: `orchestrix/skills_config.json`
- Testing config: `orchestrix/testing_config.json`
...
The `OrchestrixDB` class can be imported directly:
