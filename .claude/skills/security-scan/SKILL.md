...
- Generate `orchestrix/artifacts/{SESSION_ID}/skills/security_scan.json`
...
```bash
orchestrix/artifacts/{SESSION_ID}/skills/security_scan.json
```
...
Details saved to: orchestrix/artifacts/{SESSION_ID}/skills/security_scan.json
```
