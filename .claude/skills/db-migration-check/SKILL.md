...
- Generate `orchestrix/artifacts/{SESSION_ID}/skills/db_migration_check.json`
...
```bash
orchestrix/artifacts/{SESSION_ID}/skills/db_migration_check.json
```
...
Details saved to: orchestrix/artifacts/{SESSION_ID}/skills/db_migration_check.json
```
