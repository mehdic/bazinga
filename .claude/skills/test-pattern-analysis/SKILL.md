...
- Generate `orchestrix/artifacts/{SESSION_ID}/skills/test_patterns.json`
...
```bash
orchestrix/artifacts/{SESSION_ID}/skills/test_patterns.json
```
...
Details saved to: orchestrix/artifacts/{SESSION_ID}/skills/test_patterns.json
```
